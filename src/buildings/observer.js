...
const ob = {
    ...
    findRoomsForScan: function() {
        ...
        const lowLevel = _.filter(u.getMyCities(), c => c.controller.level < 4 && c.controller.level > 1)
        ...
        for(const roomName of roomsToScan){
            ...
            const scoutRoom = _.find(cities, city => (city.controller.level >= 4 && Game.map.getRoomLinearDistance(roomName, city.name) <= OBSERVER_RANGE)
