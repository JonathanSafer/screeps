...
function placeMiningFlags(city) {
    ...
    var modifier = Math.random() * Math.sqrt(settings.bucket.powerRange)
    if (Game.cpu.bucket >= settings.bucket.powerMining + Math.pow(modifier, 2) - (settings.bucket.powerRange/2)) {
